...
class ConcertsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create concert" do
    assert_difference('Concert.count') do
      post concerts_url, params: { concert: { attendants: @concert.attendants, date: @concert.date, group_id: @concert.group_id, length: @concert.length } }
    end
  ...
  test "should update concert" do
    patch concert_url(@concert), params: { concert: { attendants: @concert.attendants, date: @concert.date, group_id: @concert.group_id, length: @concert.length } }
